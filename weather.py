...
def calculate_mean(weather_data):
    ...
    return sum_of_numbers / len(weather_data)
    

def load_data_from_csv(csv_file):    # ERROR
...
def generate_summary(weather_data):   # ERROR
...
def generate_daily_summary(weather_data):    #ERROR
